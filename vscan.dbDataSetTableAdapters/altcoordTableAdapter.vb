...
Namespace vscan.dbDataSetTableAdapters
	...
	Public Class altcoordTableAdapter
		Inherits Component
		...
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = altcoordTableAdapter.__ENCList
			Dim flag As Boolean = False
			' The following expression was wrapped in a checked-statement
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = altcoordTableAdapter.__ENCList.Count = altcoordTableAdapter.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim arg_44_0 As Integer = 0
					Dim num2 As Integer = altcoordTableAdapter.__ENCList.Count - 1
					...
					While True
						...
						If arg_95_0 > num4 Then
							Exit While
						End If
						Dim weakReference As WeakReference = altcoordTableAdapter.__ENCList(num3)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num3 <> num
							If flag3 Then
								altcoordTableAdapter.__ENCList(num) = altcoordTableAdapter.__ENCList(num3)
							End If
							num += 1
						End If
						num3 += 1
					End While
					altcoordTableAdapter.__ENCList.RemoveRange(num, altcoordTableAdapter.__ENCList.Count - num)
					altcoordTableAdapter.__ENCList.Capacity = altcoordTableAdapter.__ENCList.Count
				End If
				altcoordTableAdapter.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
		Public Sub New()
			altcoordTableAdapter.__ENCAddToList(Me)
		...
		Private Sub InitAdapter()
			...
			tableMapping.DataSetTable = "altcoord"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT id, player, alliance, x, y, citie FROM altcoord"
		...
		Public Overridable Function Fill(dataTable As dbDataSet.altcoordDataTable) As Integer
		...
		Public Overridable Function GetData() As dbDataSet.altcoordDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As dbDataSet.altcoordDataTable = New dbDataSet.altcoordDataTable()
