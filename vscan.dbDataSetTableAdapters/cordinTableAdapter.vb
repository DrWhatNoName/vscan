...
Namespace vscan.dbDataSetTableAdapters
	...
	Public Class cordinTableAdapter
		Inherits Component
		...
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = cordinTableAdapter.__ENCList
			Dim flag As Boolean = False
			' The following expression was wrapped in a checked-statement
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = cordinTableAdapter.__ENCList.Count = cordinTableAdapter.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim arg_44_0 As Integer = 0
					Dim num2 As Integer = cordinTableAdapter.__ENCList.Count - 1
					...
					While True
						...
						If arg_95_0 > num4 Then
							Exit While
						End If
						Dim weakReference As WeakReference = cordinTableAdapter.__ENCList(num3)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num3 <> num
							If flag3 Then
								cordinTableAdapter.__ENCList(num) = cordinTableAdapter.__ENCList(num3)
							End If
							num += 1
						End If
						num3 += 1
					End While
					cordinTableAdapter.__ENCList.RemoveRange(num, cordinTableAdapter.__ENCList.Count - num)
					cordinTableAdapter.__ENCList.Capacity = cordinTableAdapter.__ENCList.Count
				End If
				cordinTableAdapter.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
		Public Sub New()
			cordinTableAdapter.__ENCAddToList(Me)
		...
		Private Sub InitAdapter()
			...
			tableMapping.DataSetTable = "cordin"
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `cordin` WHERE (((? = 1 AND `alliance` IS NULL) OR (`alliance` = ?)) AND ((? = 1 AND `player` IS NULL) OR (`player` = ?)) AND ((? = 1 AND `x` IS NULL) OR (`x` = ?)) AND ((? = 1 AND `y` IS NULL) OR (`y` = ?)) AND ((? = 1 AND `citie` IS NULL) OR (`citie` = ?)) AND (`ID` = ?))"
			...
			Me._adapter.DeleteCommand.Parameters.Add(New OleDbParameter("IsNull_citie", OleDbType.[Integer], 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Original, True, Nothing))
			Me._adapter.DeleteCommand.Parameters.Add(New OleDbParameter("Original_citie", OleDbType.VarWChar, 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Original, False, Nothing))
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `cordin` (`alliance`, `player`, `x`, `y`, `citie`, `ID`) VALUES (?, ?, ?, ?, ?, ?)"
			...
			Me._adapter.InsertCommand.Parameters.Add(New OleDbParameter("citie", OleDbType.VarWChar, 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Current, False, Nothing))
			Me._adapter.InsertCommand.Parameters.Add(New OleDbParameter("ID", OleDbType.[Integer], 0, ParameterDirection.Input, 0, 0, "ID", DataRowVersion.Current, False, Nothing))
			Me._adapter.UpdateCommand = New OleDbCommand()
			Me._adapter.UpdateCommand.Connection = Me.Connection
			Me._adapter.UpdateCommand.CommandText = "UPDATE `cordin` SET `alliance` = ?, `player` = ?, `x` = ?, `y` = ?, `citie` = ?, `ID` = ? WHERE (((? = 1 AND `alliance` IS NULL) OR (`alliance` = ?)) AND ((? = 1 AND `player` IS NULL) OR (`player` = ?)) AND ((? = 1 AND `x` IS NULL) OR (`x` = ?)) AND ((? = 1 AND `y` IS NULL) OR (`y` = ?)) AND ((? = 1 AND `citie` IS NULL) OR (`citie` = ?)) AND (`ID` = ?))"
			...
			Me._adapter.UpdateCommand.Parameters.Add(New OleDbParameter("citie", OleDbType.VarWChar, 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Current, False, Nothing))
			Me._adapter.UpdateCommand.Parameters.Add(New OleDbParameter("ID", OleDbType.[Integer], 0, ParameterDirection.Input, 0, 0, "ID", DataRowVersion.Current, False, Nothing))
			...
			Me._adapter.UpdateCommand.Parameters.Add(New OleDbParameter("IsNull_citie", OleDbType.[Integer], 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Original, True, Nothing))
			Me._adapter.UpdateCommand.Parameters.Add(New OleDbParameter("Original_citie", OleDbType.VarWChar, 0, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Original, False, Nothing))
		...
		Private Sub InitCommandCollection()
			Me._commandCollection = New OleDbCommand(5)
			Me._commandCollection(0) = New OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT alliance, player, x, y, citie, ID FROM cordin"
			Me._commandCollection(0).CommandType = CommandType.Text
			Me._commandCollection(1) = New OleDbCommand()
			Me._commandCollection(1).Connection = Me.Connection
			Me._commandCollection(1).CommandText = "SELECT        alliance, player, x, y, citie, ID" & vbCrLf & "FROM            cordin" & vbCrLf & "WHERE        (alliance LIKE ?)"
			Me._commandCollection(1).CommandType = CommandType.Text
			Me._commandCollection(1).Parameters.Add(New OleDbParameter("alliance", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "alliance", DataRowVersion.Current, False, Nothing))
			Me._commandCollection(2) = New OleDbCommand()
			Me._commandCollection(2).Connection = Me.Connection
			Me._commandCollection(2).CommandText = "SELECT        alliance, player, x, y, citie, ID" & vbCrLf & "FROM            cordin" & vbCrLf & "WHERE        (citie LIKE ?)"
			Me._commandCollection(2).CommandType = CommandType.Text
			Me._commandCollection(2).Parameters.Add(New OleDbParameter("citie", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Current, False, Nothing))
			Me._commandCollection(3) = New OleDbCommand()
			Me._commandCollection(3).Connection = Me.Connection
			Me._commandCollection(3).CommandText = "SELECT        alliance, player, x, y, citie, ID" & vbCrLf & "FROM            cordin" & vbCrLf & "WHERE        (alliance LIKE ?) OR" & vbCrLf & "                         (player LIKE ?) OR" & vbCrLf & "                         (citie LIKE ?)"
			Me._commandCollection(3).CommandType = CommandType.Text
			Me._commandCollection(3).Parameters.Add(New OleDbParameter("alliance", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "alliance", DataRowVersion.Current, False, Nothing))
			Me._commandCollection(3).Parameters.Add(New OleDbParameter("player", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "player", DataRowVersion.Current, False, Nothing))
			Me._commandCollection(3).Parameters.Add(New OleDbParameter("citie", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "citie", DataRowVersion.Current, False, Nothing))
			Me._commandCollection(4) = New OleDbCommand()
			Me._commandCollection(4).Connection = Me.Connection
			Me._commandCollection(4).CommandText = "SELECT        alliance, player, x, y, citie, ID" & vbCrLf & "FROM            cordin" & vbCrLf & "WHERE        (player LIKE ?)"
			Me._commandCollection(4).CommandType = CommandType.Text
			Me._commandCollection(4).Parameters.Add(New OleDbParameter("player", OleDbType.WChar, 255, ParameterDirection.Input, 0, 0, "player", DataRowVersion.Current, False, Nothing))
		End Sub
		...
		Public Overridable Function Fill(dataTable As dbDataSet.cordinDataTable) As Integer
		...
		Public Overridable Function GetData() As dbDataSet.cordinDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As dbDataSet.cordinDataTable = New dbDataSet.cordinDataTable()
		...
		Public Overridable Function searchalliance(dataTable As dbDataSet.cordinDataTable, alliance As String) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			Dim flag As Boolean = alliance = Nothing
			If flag Then
				Me.Adapter.SelectCommand.Parameters(0).Value = DBNull.Value
			Else
				Me.Adapter.SelectCommand.Parameters(0).Value = alliance
			End If
			flag = Me.ClearBeforeFill
			If flag Then
				dataTable.Clear()
			End If
			Return Me.Adapter.Fill(dataTable)
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DataObjectMethod(DataObjectMethodType.Fill, False), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode()>
		Public Overridable Function searchcitie(dataTable As dbDataSet.cordinDataTable, citie As String) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(2)
			Dim flag As Boolean = citie = Nothing
			If flag Then
				Me.Adapter.SelectCommand.Parameters(0).Value = DBNull.Value
			Else
				Me.Adapter.SelectCommand.Parameters(0).Value = citie
			End If
			flag = Me.ClearBeforeFill
			If flag Then
				dataTable.Clear()
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DataObjectMethod(DataObjectMethodType.Fill, False), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode()>
		Public Overridable Function searchmix(dataTable As dbDataSet.cordinDataTable, alliance As String, player As String, citie As String) As Integer
			...
			flag = (player = Nothing)
			If flag Then
				Me.Adapter.SelectCommand.Parameters(1).Value = DBNull.Value
			Else
				Me.Adapter.SelectCommand.Parameters(1).Value = player
			End If
			flag = (citie = Nothing)
			If flag Then
				Me.Adapter.SelectCommand.Parameters(2).Value = DBNull.Value
			Else
				Me.Adapter.SelectCommand.Parameters(2).Value = citie
			End If
			flag = Me.ClearBeforeFill
			If flag Then
				dataTable.Clear()
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DataObjectMethod(DataObjectMethodType.Fill, False), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode()>
		Public Overridable Function searchplayer(dataTable As dbDataSet.cordinDataTable, player As String) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(4)
			Dim flag As Boolean = player = Nothing
			If flag Then
				Me.Adapter.SelectCommand.Parameters(0).Value = DBNull.Value
			Else
				Me.Adapter.SelectCommand.Parameters(0).Value = player
			End If
			flag = Me.ClearBeforeFill
			If flag Then
				dataTable.Clear()
		...
		Public Overridable Function Update(dataTable As dbDataSet.cordinDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function

		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode()>
		Public Overridable Function Update(dataSet As dbDataSet) As Integer
			Return Me.Adapter.Update(dataSet, "cordin")
		End Function
		...
		Public Overridable Function Delete(Original_alliance As String, Original_player As String, Original_x As Integer?, Original_y As Integer?, Original_citie As String, Original_ID As Integer?) As Integer
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(1).Value = Original_alliance
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(3).Value = Original_player
			End If
			flag = Original_x.HasValue
			If flag Then
				Me.Adapter.DeleteCommand.Parameters(4).Value = 0
				Me.Adapter.DeleteCommand.Parameters(5).Value = Original_x.Value
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(9).Value = Original_citie
			End If
			flag = Original_ID.HasValue
			If flag Then
				Me.Adapter.DeleteCommand.Parameters(10).Value = Original_ID.Value
			Else
		...
		Public Overridable Function Insert(alliance As String, player As String, x As Integer?, y As Integer?, citie As String, ID As Integer?) As Integer
			Dim flag As Boolean = alliance = Nothing
			If flag Then
			...
			Else
				Me.Adapter.InsertCommand.Parameters(4).Value = citie
			End If
			flag = ID.HasValue
			If flag Then
				Me.Adapter.InsertCommand.Parameters(5).Value = ID.Value
			Else
		...
		Public Overridable Function Update(alliance As String, player As String, x As Integer?, y As Integer?, citie As String, ID As Integer?, Original_alliance As String, Original_player As String, Original_x As Integer?, Original_y As Integer?, Original_citie As String, Original_ID As Integer?) As Integer
			Dim flag As Boolean = alliance = Nothing
			If flag Then
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(4).Value = citie
			End If
			flag = ID.HasValue
			If flag Then
				Me.Adapter.UpdateCommand.Parameters(5).Value = ID.Value
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(7).Value = Original_alliance
			End If
			flag = (Original_player = Nothing)
			If flag Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = Original_player
			End If
			flag = Original_x.HasValue
			If flag Then
				Me.Adapter.UpdateCommand.Parameters(10).Value = 0
				Me.Adapter.UpdateCommand.Parameters(11).Value = Original_x.Value
			Else
			...
			If flag Then
				...
				Me.Adapter.UpdateCommand.Parameters(13).Value = Original_y.Value
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(15).Value = Original_citie
			End If
			flag = Original_ID.HasValue
			If flag Then
				Me.Adapter.UpdateCommand.Parameters(16).Value = Original_ID.Value
			Else
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DataObjectMethod(DataObjectMethodType.Update, True), HelpKeyword("vs.data.TableAdapter"), DebuggerNonUserCode()>
		Public Overridable Function Update(alliance As String, player As String, x As Integer?, y As Integer?, citie As String, Original_alliance As String, Original_player As String, Original_x As Integer?, Original_y As Integer?, Original_citie As String, Original_ID As Integer?) As Integer
			Return Me.Update(alliance, player, x, y, citie, Original_ID, Original_alliance, Original_player, Original_x, Original_y, Original_citie, Original_ID)
		End Function
	End Class
End Namespace
