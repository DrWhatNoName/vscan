...
Namespace vscan.dbDataSetTableAdapters
	...
	Public Class neutralcoordTableAdapter
		Inherits Component
		...
		Private Shared Sub __ENCAddToList(value As Object)
			Dim _ENCList As List(Of WeakReference) = neutralcoordTableAdapter.__ENCList
			Dim flag As Boolean = False
			' The following expression was wrapped in a checked-statement
			Try
				Monitor.Enter(_ENCList, flag)
				Dim flag2 As Boolean = neutralcoordTableAdapter.__ENCList.Count = neutralcoordTableAdapter.__ENCList.Capacity
				If flag2 Then
					Dim num As Integer = 0
					Dim arg_44_0 As Integer = 0
					Dim num2 As Integer = neutralcoordTableAdapter.__ENCList.Count - 1
					...
					While True
						...
						If arg_95_0 > num4 Then
							Exit While
						End If
						Dim weakReference As WeakReference = neutralcoordTableAdapter.__ENCList(num3)
						flag2 = weakReference.IsAlive
						If flag2 Then
							Dim flag3 As Boolean = num3 <> num
							If flag3 Then
								neutralcoordTableAdapter.__ENCList(num) = neutralcoordTableAdapter.__ENCList(num3)
							End If
							num += 1
						End If
						num3 += 1
					End While
					neutralcoordTableAdapter.__ENCList.RemoveRange(num, neutralcoordTableAdapter.__ENCList.Count - num)
					neutralcoordTableAdapter.__ENCList.Capacity = neutralcoordTableAdapter.__ENCList.Count
				End If
				neutralcoordTableAdapter.__ENCList.Add(New WeakReference(RuntimeHelpers.GetObjectValue(value)))
			Finally
		...
		<GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), DebuggerNonUserCode()>
		Public Sub New()
			neutralcoordTableAdapter.__ENCAddToList(Me)
		...
		Private Sub InitAdapter()
			...
			tableMapping.DataSetTable = "neutralcoord"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT id, alliance, player, x, y FROM neutralcoord"
		...
		Public Overridable Function Fill(dataTable As dbDataSet.neutralcoordDataTable) As Integer
		...
		Public Overridable Function GetData() As dbDataSet.neutralcoordDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As dbDataSet.neutralcoordDataTable = New dbDataSet.neutralcoordDataTable()
